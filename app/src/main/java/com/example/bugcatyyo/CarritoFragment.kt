...
class CarritoFragment : Fragment() {
    ...
    private fun actualizarMontoTotal() {
        ...
        val montoTotalFormateado = if (montoTotal % 1 == 0.0) {
            String.format("Total a pagar: S/. %.1f0    ", montoTotal)
        } else {
            String.format("Total a pagar: S/. %.1f    ", montoTotal)
        }

        txtMontoTotal.text = montoTotalFormateado
    }
